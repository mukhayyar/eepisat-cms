...
@section('body')
<!-- Page header -->
    @include('shared.backoffice_page_header',['title'=>"Dashboard"])
    <!-- Page body -->
    <div class="page-body">
        ...
        <div class="row row-deck row-cards">
            ...
            <div class="row row-cards">
                ...
                <div class="card">
                    <div class="card-body">
                    <p class="mb-3">CanSat Progress <strong>CDR </strong></p>
                    <div class="card">
                        <div class="card-body">
                            <ul class="steps steps-green my-4">
                                <li class="step-item">
                                  ...
                                  <li class="step-item">
                                    ...
                                    <div class="text-muted">PDR</div>
                                  </li>
                                  <li class="step-item active">
                                    <div class="h4 m-0">3</div>
                                    <div class="text-muted">CDR</div>
                                  </li>
                                  <li class="step-item">
                                    <div class="h4 m-0">4</div>
                                    <div class="text-muted">Enviromental Test</div>
                                  </li>
                                  <li class="step-item">
                                    <div class="h4 m-0">5</div>
                                    <div class="text-muted">Launch Day</div>
                                  </li>
                            </ul>
                        </div>
                    </div>
