...
<head>
    ...
    <link rel="icon" href="https://d33wubrfki0l68.cloudfront.net/9c80d635033669c5a01e07bad6ad4216eb6d28d6/d3243/asset/eepisat.png" type="image/gif">
    <title>EEPISAT - Backoffice</title>
    <!-- CSS files -->
        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="/static/eepisat-logo.svg" width="110" height="32" alt="Tabler"
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col text-truncate">
                                                    <a href="#" class="text-body d-block">No Update</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <div class="d-none d-xl-block ps-2">
                                ...
                                <div class="mt-1 small text-muted">{{Auth::user()->position->name}}</div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="#" class="dropdown-item">Status</a>
                            <a href="/backoffice/profile" class="dropdown-item">Profile</a>
                            <div class="dropdown-divider"></div>
                            <a href="/backoffice/settings" class="dropdown-item">Settings</a>
                    ...
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            <li class="nav-item @yield('home_active', '')">
                                <a class="nav-link" href="/backoffice/dashboard">
                            ...
                            <li class="nav-item dropdown @yield('layout_active', '')">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <a class="dropdown-item @yield('layout_home_active', '')" 
                                                href="{{route('article.index')}}">
                                                Article
                                            </a>
                                            <a class="dropdown-item @yield('layout_about_us_active', '')"
                                                href="">
                                                Sponsor
                                            </a>
                                            <a class="dropdown-item @yield('layout_gallery_active', '')"
                                                href="{{route('awarding.index')}}">
                                                Awarding
                                            </a>
                                            <a class="dropdown-item @yield('layout_gallery_active', '')"
                                        ...
                                        <div class="dropdown-menu-column">
                                            <a class="dropdown-item @yield('layout_teams_active', '')"
                                                href="{{route('competitions.index')}}">
                                                Competitions
                                            </a>
                                            <a class="dropdown-item @yield('layout_sponsorship_active', '')"
                                                href="{{route('teams.index')}}">
                                                Teams
                                            </a>
                                            <a class="dropdown-item @yield('layout_contact_active', '')"
                                                href="{{route('cansat_timeline.index')}}">
                                                CanSat Timeline
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item dropdown @yield('form_active', '')">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item @yield('form_registration_active', '')" href="/backoffice/users/super-admin">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-inline me-1 icon-tabler-forms" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" fill="none" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    ...
                                    <a class="dropdown-item @yield('form_contact_active', '')" href="/backoffice/users/admin">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-inline me-1 icon-tabler-address-book" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" fill="none" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="row text-center align-items-center flex-row-reverse">
                    ...
                    <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">
                                Copyright &copy; 2023
                                <a href="." class="link-secondary">EEPISAT Dev Team</a>.
                                All rights reserved.
                            </li>
                            <li class="list-inline-item">
