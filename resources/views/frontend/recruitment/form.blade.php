  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <div class="card card-md" style="display:block;">
          <div class="card-body text-center py-4 p-sm-5">
            <img src="/static/illustrations/undraw_sign_in_e6hj.svg" height="120" class="mb-n2" alt="">
            <h1 class="mt-5">Welcome to EEPISAT Open Recruitment!</h1>
            <p class="text-muted">Hello Aerofolks! interest in joining EEPISAT? sign up yourself here then!</p>
          </div>
        ...
        <div class="card card-md" style="display:none;">
          <div class="card-body text-center py-4 p-sm-5">
            <img src="/static/illustrations/undraw_sign_in_e6hj.svg" height="120" class="mb-n2" alt="">
            <h1 class="mt-5">Fill your data.</h1>
