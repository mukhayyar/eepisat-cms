!function(t, e) {
    ...
    var h = {
      ...
      , u = function() {
        function e() {
            ...
            this.isMobile && (this.smooth = this.smartphone.smooth),
            this.isTablet && (this.smooth = this.tablet.smooth),
            ...
            this.isMobile && (this.gestureDirection = this[this.context].gestureDirection),
            ...
            value: function(t) {
                ...
                Object.entries(this.els).forEach((function(r) {
                    var l = a(r, 2)
                      , c = l[0]
                      , h = l[1];
                    if (!h || h.inView && !t || ("horizontal" === e.direction ? s >= h.left && n < h.right && e.setInView(h, c) : o >= h.top && i < h.bottom && e.setInView(h, c)),
                    h && h.inView)
                        if ("horizontal" === e.direction) {
                            var u = h.right - h.left;
                            h.progress = (e.instance.scroll.x - (h.left - e.windowWidth)) / (u + e.windowWidth),
                            (s < h.left || n > h.right) && e.setOutOfView(h, c)
                        } else {
                            var d = h.bottom - h.top;
                            h.progress = (e.instance.scroll.y - (h.top - e.windowHeight)) / (d + e.windowHeight),
                            (o < h.top || i > h.bottom) && e.setOutOfView(h, c)
                        }
                }
                )),
                this.hasScrollTicking = !1
        ...
        t.exports = {
            polyfill: function() {
                ...
                if (!("scrollBehavior"in e.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                    var i, o = t.HTMLElement || t.Element, n = {
                    ...
                    o.prototype.scrollIntoView = function() {
                        if (!0 !== a(arguments[0])) {
                            ...
                            i !== e.body ? (p.call(this, i, i.scrollLeft + s.left - o.left, i.scrollTop + s.top - o.top),
                ...
                function f(e) {
                    ...
                    e.method.call(e.scrollable, o, n),
                    o === e.x && n === e.y || t.requestAnimationFrame(f.bind(t, e))
                }
                function p(i, o, r) {
                    var a, c, h, u, d = s();
                    i === e.body ? (a = t,
    ...
    function p(t) {
        ...
        if (window.getComputedStyle) {
            ...
            e.y = n ? parseFloat(n[1].split(", ")[13]) : 0) : (n = o.match(/^matrix\((.+)\)$/),
    ...
    var g = d((function(t, e) {
        t.exports = function() {
            ...
            var n = o;
            n.TinyEmitter = o;
            var s, r = "virtualscroll", l = e("options"), a = e("el"), c = e("emitter"), h = e("event"), u = e("touchStart"), d = e("bodyTouchAction");
            return function() {
                function t(t) {
                    var e = this;
                    ...
                    this._onWheel = function(t) {
                        ...
                        s.isFirefox && 1 === t.deltaMode && (n.deltaX *= o.firefoxMultiplier,
                    ...
                    this._onTouchMove = function(t) {
                        ...
                        n.deltaX = (s.pageX - i(e, u)[u].x) * o.touchMultiplier,
                        n.deltaY = (s.pageY - i(e, u)[u].y) * o.touchMultiplier,
                        i(e, u)[u].x = s.pageX,
                        i(e, u)[u].y = s.pageY,
                        e._notify(t)
                    }
                    ...
                    i(this, d)[d] = null,
                    void 0 !== i(this, l)[l].passive && (this.listenerOptions = {
                ...
                ,
                e._bind = function() {
                    s.hasWheelEvent && i(this, a)[a].addEventListener("wheel", this._onWheel, this.listenerOptions),
                    s.hasMouseWheelEvent && i(this, a)[a].addEventListener("mousewheel", this._onMouseWheel, this.listenerOptions),
                    s.hasTouch && i(this, l)[l].useTouch && (i(this, a)[a].addEventListener("touchstart", this._onTouchStart, this.listenerOptions),
                    i(this, a)[a].addEventListener("touchmove", this._onTouchMove, this.listenerOptions)),
                    s.hasPointer && s.hasTouchWin && (i(this, d)[d] = document.body.style.msTouchAction,
                    document.body.style.msTouchAction = "none",
                    i(this, a)[a].addEventListener("MSPointerDown", this._onTouchStart, !0),
                    i(this, a)[a].addEventListener("MSPointerMove", this._onTouchMove, !0)),
                    s.hasKeyDown && i(this, l)[l].useKeyboard && document.addEventListener("keydown", this._onKeyDown)
                }
                ,
                e._unbind = function() {
                    s.hasWheelEvent && i(this, a)[a].removeEventListener("wheel", this._onWheel),
                    s.hasMouseWheelEvent && i(this, a)[a].removeEventListener("mousewheel", this._onMouseWheel),
                    s.hasTouch && (i(this, a)[a].removeEventListener("touchstart", this._onTouchStart),
                    i(this, a)[a].removeEventListener("touchmove", this._onTouchMove)),
                    s.hasPointer && s.hasTouchWin && (document.body.style.msTouchAction = i(this, d)[d],
                    i(this, a)[a].removeEventListener("MSPointerDown", this._onTouchStart, !0),
                    i(this, a)[a].removeEventListener("MSPointerMove", this._onTouchMove, !0)),
                    s.hasKeyDown && i(this, l)[l].useKeyboard && document.removeEventListener("keydown", this._onKeyDown)
                }
                ,
                e.on = function(t, e) {
                    i(this, c)[c].on(r, t, e);
    ...
    var S = ["duration", "easing"]
            ...
            : r
              , a = function(t, e) {
                ...
                for (o = 0; o < s.length; o++)
                    e.indexOf(i = s[o]) >= 0 || (n[i] = t[i]);
                return n
            }(o, S);
            this.target = t,
            this.fromKeys = k({}, a),
            this.toKeys = k({}, a),
            this.keys = Object.keys(k({}, a)),
      ...
      , O = function(t) {
        var e, i;
        function o(e) {
            var i, o, n, s, r = void 0 === e ? {} : e, l = r.duration, a = void 0 === l ? 1.2 : l, c = r.easing, h = void 0 === c ? function(t) {
                return 1 === t ? 1 : 1 - Math.pow(2, -10 * t)
            }
            : c, u = r.smooth, d = void 0 === u || u, f = r.smoothTouch, p = void 0 !== f && f, v = r.touchMultiplier, m = void 0 === v ? 2 : v, y = r.direction, w = void 0 === y ? "vertical" : y, b = r.gestureDirection, T = void 0 === b ? "vertical" : b, k = r.wrapper, E = void 0 === k ? window : k, S = r.content, O = void 0 === S ? document.body : S;
            ...
            s.onWrapperResize = function(t) {
                ...
                if (e) {
                    var i = e.contentRect;
                    s.wrapperWidth = i.width,
                    s.wrapperHeight = i.height
                }
            }
            ,
            s.onContentResize = function(t) {
                ...
                if (e) {
                    var i = e.contentRect;
                    s.contentWidth = i.width,
                    s.contentHeight = i.height
                }
            }
            ,
            s.onVirtualScroll = function(t) {
                var e = t.deltaY
                  , i = t.deltaX
                  , o = t.originalEvent;
                o.ctrlKey || (s.smooth = o.changedTouches ? s.smoothTouch : s.options.smooth,
                s.stopped ? o.preventDefault() : s.smooth && 4 !== o.buttons && (s.smooth && o.preventDefault(),
                s.targetScroll -= "both" === s.gestureDirection ? i + e : "horizontal" === s.gestureDirection ? i : e,
                s.targetScroll = Math.max(0, Math.min(s.targetScroll, s.limit)),
                s.scrollTo(s.targetScroll)))
            }
            ,
            s.onScroll = function(t) {
                s.isScrolling && s.smooth || (s.targetScroll = s.scroll = s.lastScroll = s.wrapperNode[s.scrollProperty],
                s.notify())
            }
            ,
            window.lenisVersion = "0.2.9",
            s.options = {
                duration: a,
                easing: h,
                smooth: d,
            ...
            s.touchMultiplier = m,
            s.direction = w,
            s.gestureDirection = T,
            s.wrapperNode = E,
            s.contentNode = O,
            s.wrapperNode.addEventListener("scroll", s.onScroll),
            s.wrapperNode === window ? (s.wrapperNode.addEventListener("resize", s.onWindowResize),
            s.onWindowResize()) : (s.wrapperHeight = s.wrapperNode.offsetHeight,
            ...
            s.targetScroll = s.scroll = s.lastScroll = s.wrapperNode[s.scrollProperty],
            s.animate = new x;
        ...
        n.scrollTo = function(t, e) {
            ...
            if (null != t) {
                ...
                this.targetScroll = u += n,
                !this.smooth || r ? this.setScroll(this.targetScroll) : this.animate.to(this, {
                    duration: a,
                    easing: h,
      ...
      , M = function(e) {
        ...
        function c() {
            ...
            window.scrollTo(0, 0)),
            void 0 === window.smoothscrollPolyfill && (window.smoothscrollPolyfill = f,
        ...
        return i(c, [{
            key: "init",
            value: function() {
                this.smooth && (this.html.classList.add(this.smoothClass),
                ...
                this.raf(0),
                l(o(c.prototype), "init", this).call(this)
            }
        }, {
            key: "raf",
            value: function(t) {
            ...
            value: function(t) {
                var e = this
                  , i = t.scroll
                  , n = t.velocity;
                i > this.instance.scroll[this.directionAxis] ? "down" !== this.instance.direction && (this.instance.direction = "down") : i < this.instance.scroll[this.directionAxis] && "up" !== this.instance.direction && (this.instance.direction = "up"),
                ...
                l(o(c.prototype), "onScroll", this).call(this),
            ...
            value: function() {
                ...
                this.checkContext(),
                this.initContainerSize(),
                Object.entries(this.els).length && this.update()
            }
        }, {
            ...
            value: function() {
                ...
                this.el.querySelectorAll("[data-" + this.name + "]").forEach((function(e, i) {
                    ...
                    var v, m = e.dataset[t.name + "Target"], y = (v = void 0 !== m ? document.querySelector("".concat(m)) : e).getBoundingClientRect();
                    o = y.top + t.instance.scroll.y - p(v).y,
                    n = y.left + t.instance.scroll.x - p(v).x;
                    ...
                    if (f) {
                        ...
                        n += window.innerWidth,
                        w = k + v.offsetHeight - e.offsetHeight - S[t.directionAxis],
                        b = {
                    ...
                    if (l)
                        if ("horizontal" === t.direction) {
                            for (var M = 0; M < l.length; M++)
                                "string" == typeof l[M] ? l[M].includes("%") ? O[M] = parseInt(l[M].replace("%", "") * t.windowWidth / 100) : O[M] = parseInt(l[M]) : O[M] = l[M];
                            n += O[0],
                            g -= O[1]
                        } else {
                            for (M = 0; M < l.length; M++)
                                "string" == typeof l[M] ? l[M].includes("%") ? O[M] = parseInt(l[M].replace("%", "") * t.windowHeight / 100) : O[M] = parseInt(l[M]) : O[M] = l[M];
                            o += O[0],
                            w -= O[1]
                        }
                    var W = {
                    ...
                    t.els[r] = W,
                    e.classList.contains(s) && t.setInView(t.els[r], r),
                    (!1 !== x || f) && (t.parallaxElements[r] = W)
                }
                ))
            }
        }, {
            ...
            key: "destroy",
            value: function() {
                l(o(c.prototype), "destroy", this).call(this),
    ...
    return function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                this.smooth && !this.options.isMobile || this.tablet.smooth && this.options.isTablet || this.smartphone.smooth && this.options.isMobile && !this.options.isTablet ? this.smooth = !0 : this.smooth = !1,
